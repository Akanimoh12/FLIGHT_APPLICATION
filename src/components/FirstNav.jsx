              ...
              <div className="grid grid-cols-1 shadow-black shadow-md md:grid-cols-2 lg:grid-cols-3 gap-6 p-2">
                ...
                >
                  <p className='w-full bg-gray-600 h-20 text-center justify-items-center rounded-md '>
                      ...
                      <p className='text-white font-bold'>{flight.departure?.airport} </p>
                  ...
                  <p className='p-1'>Departure Time: {flight.departure?.scheduled}</p>
                  <p className='p-1'>Arrival Time: {flight.arrival?.scheduled}</p>
